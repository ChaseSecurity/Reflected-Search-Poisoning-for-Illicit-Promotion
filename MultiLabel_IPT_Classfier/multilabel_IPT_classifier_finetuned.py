...
labels_list = []
labels_dict = {}
with open(f'labels.txt', 'r', encoding='utf-8') as fp:
    reader = fp.readlines()
...
# Get Train Set
with open(f'{ground_truth_dir}/labeled_data.csv', mode='r', encoding='utf-8') as fp:
...
train_df, eval_df = train_test_split(sample_df, test_size=0.2, random_state=1)

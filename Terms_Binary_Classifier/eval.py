...
positive_cases = [
    ...
    for line in open("./positive_data.txt", encoding='utf-8')
]
negative_cases = [
    (
        ast.literal_eval(line.strip())[0],
    ...
    for line in open("./negative_data.txt", encoding='utf-8')
]
positive_tests = [
    (
        line.strip(),
    ...
    for line in open("./positive_data_for_eval.txt", encoding='utf-8')
]
negative_tests = [
    (
        line.strip(),
    ...
    for line in open("./negative_data_for_eval.txt", encoding='utf-8')
]
# TODO deduplicate

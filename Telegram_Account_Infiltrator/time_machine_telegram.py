...
class TelegramTimeMachine:
    # TODO: get from 'https://my.telegram.org'
    api_id = 0000000
    ...
    async def get_channel_info(
        ...
        with open(os.path.join(result_dir, "messages.json"), "w", encoding='utf-8', newline='\n') as fd:
            async for message in self.client.iter_messages(entity, reverse = True, offset_date=self.today-datetime.timedelta(days=7), wait_time=1):

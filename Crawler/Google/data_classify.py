...
with open('result/negative_data_predicted_fromcontact.txt', 'w', encoding='utf-8') as fp:
    for item in negative_data_predicted:
        fp.write(item)

with open('result/positive_data_predicted_fromcontact.txt', 'w', encoding='utf-8') as fp:
...
with open('result/result_from_site.txt', 'r', encoding='utf-8') as fp:
    all_data = fp.readlines()
...
logging.info(f'Finish predict, with positive {len(positive_data_predicted)}, negative {len(negative_data_predicted)}')
with open('result/negative_data_predicted_fromsite.txt', 'w', encoding='utf-8') as fp:
    for item in negative_data_predicted:
        fp.write(item)

with open('result/positive_data_predicted_fromsite.txt', 'w', encoding='utf-8') as fp:
    for item in positive_data_predicted:
        fp.write(item)
